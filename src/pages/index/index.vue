	...
	<view class="index">
			<view class="container">
				...
				<view class="content">
					...
					<view class="row flex  -x-b">
						<text>新上盲盒</text>
						<text>更多</text>
					</view>
					<card list="1"></card>
					<view class="row flex f-x-b" @click="">
						<text>热卖专区</text>
						<text>更多
						<image class="arrow" src="@/static/img/center/rightArrow.png" mode=""></image></text>
