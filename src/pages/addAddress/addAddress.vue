<template>
	<view class="add">
		<u-navbar title="添加收货地址" @rightClick="rightClick" :autoBack="true">
		</u-navbar>
		...
		<view class="content">
			...
			<view class="addressInfo">
				...
				<view class="item flex">
					...
					<input :maxlength="11" placeholder-style="color: #999" type="number" placeholder="请填写收货人的手机号码">
				</view>
				<view class="item flex" @click="addressShows">
					<view class="title">选择地区</view>
					<input disabled placeholder-style="color: #999" type="text" v-model="areaAddress" placeholder="请选择省、市、区">
